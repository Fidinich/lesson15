...
function myPow(a, b, fn) {
  let pow = function (x, n) {
    return n == 0 ? 1 : n !== 1 ? (x *= pow(x, n - 1)) : x;
  };
  return fn(a, b, pow(a, b));
}

console.log(myPow(3, 0, myPrint)); // 3^4=81

console.log(myPow(2, 5, myPrint)); // 2^3=8
...
let list = [12, 23, 100, 3994, 56, 9, 233];
...
let myDouble = myMul.bind(this, 2);

console.log(myDouble(4)); // = myMul(2, 4) = 8

console.log(myDouble(5)); // = myMul(2, 5) = 10

let myTriple = myMul.bind(this, 3);
